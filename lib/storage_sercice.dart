...
class Storage {
 final firebase_storage.FirebaseStorage storage = firebase_storage.FirebaseStorage.instance;
        ...
        (
         ...
         Future<void> uploadImagesComits
        (
          String filePath,
          String fileName,
        ) async{
          File file =File(filePath);
          try{
            await storage.ref('Comits/$fileName').putFile(file);
          } on firebase_core.FirebaseException catch (e){
            print(e);
          }
        }
        ...
        Future<String>downloadURLComits(String imageName)async{
          String downloadURL =await storage.ref('Comits/$imageName').getDownloadURL();
          //print(downloadURL);
          return downloadURL;
        }
